        ...
        <div class="sellerInfo-content-table">
          <table>
            <tbody>
              <tr>
                ...
                <td>
                  <div class="seller-profile-thumbnail">
                    ...
                    />
                    <img
                      v-else-if="sellerInfo.seller_profile"
                      :src="sellerInfo.seller_profile"
                      alt="profile_img"
                    />
                  ...
                  <div v-if="profileImageUrl">
                    ...
                    <a-button type="danger" @click="onClickImageDelete"
                      >삭제</a-button
                    >
                  </div>
                  <div v-else>
              ...
              <tr>
                <td>셀러 속성 <label class="font-color-red">*</label></td>
                <td>
                  <a-radio-group
                    name="radioGroup"
                    v-model="sellerInfo.seller_attribute_id"
                  >
                    <a-radio
                      v-for="attribute in attributeInfo"
              ...
              <tr>
                ...
                <td>
                  ...
                  <a-modal
                    ...
                    title="비밀번호 변경하기"
                    on-ok="passwordChangeShowModalHandleOk"
                  >
                    <template slot="footer">
                      <a-button
                        key="back"
                        @click="passwordChangeShowModalHandleCancel"
                      >
                        취소
                      </a-button>
                      <a-button
                        ...
                        type="success"
                        :loading="loading"
                        @click="passwordChangeShowModalHandleOk"
                      >
                        변경
                      </a-button>
                    </template>
        ...
        <div class="sellerInfo-content-table">
          <table>
            <tbody>
              <tr>
                <td>
                  셀러페이지 배경이미지 <label class="font-color-red">*</label>
                </td>
                <td>
                  <div class="seller-profile-thumbnail">
                    <img
                    ...
                    />
                    <img
                      v-else-if="sellerInfo.seller_background"
                      :src="sellerInfo.seller_background"
                      alt="backgroun_img"
                    />
                    <img v-else :src="noImg" alt="noimage" />
                  </div>
                  <div v-if="backgroundImageUrl">
                    ...
                    <a-button
                      type="danger"
                      @click="onClickBackgroundImageDelete"
                      >삭제</a-button
                    >
                  </div>
                  <div v-else>
                  ...
                  <div class="padding-top-10">
                    <div class="sellerInfo-content-table-font-blue">
                      <a-icon type="info-circle" />
                      브랜디 앱과 웹 사이트의 셀러 페이지에 보여질 배경이미지
                      입니다.
                      <br />
                      <a-icon type="info-circle" />
                      배경이미지는
              ...
              <tr>
                <td>셀러 한줄 소개 <label class="font-color-red">*</label></td>
                <td>
                  <div class="input-size">
                    <a-input
                      ref="userNameInput"
                      v-model="sellerInfo.seller_intro"
                  ...
                  <div>
                    <div class="input-size">
                      <a-textarea
                        ...
                        v-model="sellerInfo.seller_detail"
                        :rows="4"
                        allow-clear
                        @change="onChange"
                      />
                ...
                <td>
                  <div>
                    ...
                    <div class="margin-bottom-5 input-size">
                      <a-input
                        ref="userNameInput"
                        v-model="sellerInfo.owner_number"
                    ...
                    <div class="margin-float input-size">
                      <a-input
                        ref="userNameInput"
                        v-model="sellerInfo.owner_email"
                        placeholder="담당자 이메일"
                      >
                ...
                <td>
                  <div>
                    ...
                    <div class="margin-bottom-5 input-size">
                      <a-input
                        ref="userNameInput"
                        v-model="sellerInfo.first_address"
                    ...
                    <div class="margin-bottom-5 input-size">
                      <a-input
                        ref="userNameInput"
                        v-model="sellerInfo.last_address"
              ...
              <tr>
                <td>
                  고객센터 운영시간 (주중)
                  <label class="font-color-red">*</label>
                </td>
                <td>
                  <div class="sellerInfo-content-table-font-blue">
                    <a-icon type="info-circle" />
  ...
  methods: {
    ...
    async getAttributeInfo() {
      try {
        ...
        const target_attribute = this.attributeInfo.filter(
          (attribute) =>
            this.sellerInfo.seller_attribute_id ===
            attribute.seller_attribute_id
        );
        const [attribute] = target_attribute;
        const attributeInfo = this.attributeInfo.filter(
          (item) =>
            item.seller_attributes_categories_id ===
            attribute.seller_attributes_categories_id
        );
    ...
    async getStatusInfo(fdata) {
      try {
        ...
        for (let i = 0; i < statusInfo.length; i++) {
          if (
            this.sellerInfo.seller_status_id === statusInfo[i].seller_status_id
          ) {
